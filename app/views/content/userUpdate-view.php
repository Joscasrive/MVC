...
?>
	...
	<p class="has-text-centered pb-6"><strong>Usuario creado:</strong> <?php  echo date("d-m-Y h:i:s A",strtotime($datos['usuario_creado'])); ?> &nbsp; <strong>Usuario actualizado:</strong> <?php  echo date("d-m-Y h:i:s A",strtotime($datos['usuario_actualizado'])); ?></p>
